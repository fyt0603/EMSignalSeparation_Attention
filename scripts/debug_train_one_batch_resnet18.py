...
运行方式（项目根目录）：
- python -m scripts.debug_train_one_batch_resnet18
- python scripts/debug_train_one_batch_resnet18.py
"""
...
def main() -> None:
    ...
    print("=== Debug One Batch Training (ResNet18) ===")
    ...
    model = ResNet18Separator(in_channels=1, out_masks=2).to(device)
