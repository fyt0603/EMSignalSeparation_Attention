...
def main() -> None:
    ...
    file_map: Dict[str, str] = {
        "LSTM": str(log_dir / "train_history_lstm.json"),
        "ResNet18": str(log_dir / "train_history_resnet18.json"),
        "U-Net": str(log_dir / "train_history_unet.json"),
        "PA-TransformerNet (proposed)": str(log_dir / "s0_train_history_transformer.json"),
    }

    style_map: Dict[str, Dict[str, str]] = {
        "LSTM": {"color": "#4C78A8", "marker": "o"},
        "ResNet18": {"color": "#F58518", "marker": "s"},
        "U-Net": {"color": "#54A24B", "marker": "^"},
    ...
    plot_metric(
        ...
        output_path=out_dir / "compare_val_total_loss.png",
        styles=style_map,
    )
    ...
    plot_metric(
        ...
        output_path=out_dir / "compare_val_corr_coef.png",
        styles=style_map,
    )

    print("Saved figures:")
    print(f"- {out_dir / 'compare_val_total_loss.png'}")
    print(f"- {out_dir / 'compare_val_corr_coef.png'}")
